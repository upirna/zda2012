...
class Standard_Controller_Helper_Params extends Zend_Controller_Action_Helper_Abstract {
    ...
    public function init()
    {
         ...
         * 
         */
        if(!isset($_SESSION['ignoreSeqIds'])) {
        	$_SESSION['ignoreSeqIds'] = array();
        }    
        ...
        switch (true) {
            ...
            case (strstr($contentType, 'application/json')):
                $this->setBodyParams(json_decode($rawBody, true));
                break;
